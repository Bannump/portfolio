...
export default function Hero() {
  return (
    <header className="hero min-h-screen flex items-center justify-center px-6 sm:px-8 lg:px-12 xl:px-16 pt-16">
      <div className="max-w-7xl mx-auto w-full overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-8 lg:gap-16 xl:gap-20 items-start">
          {/* Left Side: Name and Content */}
          <div className="text-left space-y-6 lg:space-y-8 relative z-10 min-w-0">
            <div className="space-y-4">
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-mono font-bold text-foreground leading-tight">
                <span className="whitespace-nowrap inline-block">
                  <span className="text-accent">Saratchandra Patnaik</span>
                </span>
              </h1>
              <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl text-foreground font-mono leading-relaxed">
                Architecting Intelligent Systems at Scale
              </p>
            </div>
            
            <div className="pt-4 border-t border-accent/20">
              <p className="text-base sm:text-lg md:text-xl text-foreground mb-4 font-mono leading-relaxed">
              ...
              <p className="text-sm sm:text-base md:text-lg text-foreground/80 font-mono mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-start">
              <a
                href="#projects"
                className="btn-primary px-8 py-3 bg-accent text-background font-mono font-semibold rounded-md hover:bg-accent-dark transition-all duration-300 transform hover:scale-105 shadow-lg shadow-accent/20"
              >
                View My Work
              </a>
              <a
                ...
                download
                className="btn-secondary px-8 py-3 border border-accent text-accent font-mono font-semibold rounded-md hover:bg-accent/10 transition-all duration-300 transform hover:scale-105"
              >
                Download Resume
              </a>
            </div>
          ...
          <div className="flex justify-center lg:justify-end overflow-hidden lg:w-auto">
            <div className="relative group w-full max-w-xs sm:max-w-sm md:max-w-md lg:w-80 lg:max-w-none xl:w-96">
